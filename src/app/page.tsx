    ...
    return (
        <div className="w-full text-center">
            ...
            <div className='max-w-[1240px] w-full mx-auto p-2 py-10 justify-center items-center text-left'>
                <h1 className='bg-[#404040] text-white rounded-lg w-[20rem] text-center text-2xl m-2 p-1 shadow-lg'>新しい化学のツール</h1>
            ...
            <div className='max-w-[1240px] w-full mx-auto p-2 py-10 justify-center items-center text-left'>
                <h1 className='bg-[#404040] text-white rounded-lg w-[20rem] text-center text-2xl m-2 p-1 shadow-lg'>新しい働き方、自動化</h1>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 items-center'>
                    <div className='mx-auto text-center'>
                        <Image
            ...
            <div id='about' className='max-w-[1240px] w-full mx-auto p-2 py-10 justify-center items-center text-left'>
                <h1 className='bg-[#404040] text-white rounded-lg w-[20rem] text-center text-2xl m-2 p-1 shadow-lg'>化学者のビジネス</h1>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 items-center'>
