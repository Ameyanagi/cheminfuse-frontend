          ...
          <div className="lg:p-4 h-full">
            <div>
              <img
                ...
                src="https://unsplash.com/photos/guiQYiRxkZY/download?ixid=MnwxMjA3fDB8MXxzZWFyY2h8MTZ8fGVtYWlsfGVufDB8fHx8MTY3NjkwODY4OA&w=640"
                alt=""
              />
            </div>

            <div>
              <h2 className="py-2 text-2xl">Ameyanagi, Ph.D.</h2>
              <p>Chemist, Programmer, Data Scientist, Prompt Engineer</p>
              <p className="py-4">
                Feel free to contact me for any questions, requests, or
                inquiries. <br />
                技術的な質問、記事の要望、仕事の依頼、広告掲載の依頼など気軽にお問い合わせください。
              </p>
              ...
              <div className="pt-10">
                ...
                <div className="flex items-center justify-start my-4 w-full sm:w-[80%]">
                  ...
                  <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-ind duration-10">
                    <Link href="https://github.com/Ameyanagi">
                      <FaGithub />
                    </Link>
                  </div>
                  <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-ind duration-10">
                    <Link href="https://www.linkedin.com/in/ryuichi-shimogawa-732081266/">
                      <FaLinkedinIn />
                    </Link>
                  </div>
                </div>
